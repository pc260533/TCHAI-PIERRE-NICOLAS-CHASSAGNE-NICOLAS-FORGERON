...
class StockageBaseDeDonnees(object):
    ...
    def __init__(self, nomBaseDeDonnee: str):
        ...
        self.cursor.execute("""CREATE TABLE IF NOT EXISTS utilisateur (
                                ...
                                clePubliqueUtilisateur TEXT NOT NULL);""");
    ...
    def ajouterUtilisateur(self, utilisateur: Utilisateur):
        try:
            sql = "INSERT INTO utilisateur (nomUtilisateur, montantInitialUtilisateur, clePubliqueUtilisateur) VALUES (:nomUtilisateur, :montantInitialUtilisateur, :clePubliqueUtilisateur);";
            self.cursor.execute(sql, {"nomUtilisateur": utilisateur.nomUtilisateur, "montantInitialUtilisateur": utilisateur.montantInitialUtilisateur, "clePubliqueUtilisateur": utilisateur.clePubliqueUtilisateur});
            self.connection.commit();
    ...
    def chargerUtilisateurAvecNom(self, nomUtilisateur: str) -> Utilisateur:
        try:
            ...
            sql = "SELECT nomUtilisateur, montantInitialUtilisateur, clePubliqueUtilisateur FROM utilisateur WHERE nomUtilisateur = :nomUtilisateur";
            self.cursor.execute(sql, {"nomUtilisateur": nomUtilisateur});
            ...
            utilisateur.clePubliqueUtilisateur = utilisateurLigne[2];
            return utilisateur;
        except sqlite3.Error as errorSqlite3:
            raise ExceptionGestionBaseDeDonnees(errorSqlite3);
