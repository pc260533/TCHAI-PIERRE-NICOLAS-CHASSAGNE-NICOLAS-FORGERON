from views.SignerTransactionView import SignerTransactionView
...
def main():
    stockageBaseDeDonnee = StockageBaseDeDonnees("tchai4.db");
    app = Flask(__name__);
    ...
    app.add_url_rule("/signerTransaction", view_func = SignerTransactionView.as_view("signerTransaction", "signerTransactionConfirmation.html", stockageBaseDeDonnee));
